...
exports.Call = class Call extends Base
    ...
    compileNode: (o) -> # Compile a vanilla function call.
...
exports.TaggedTemplateCall = class TaggedTemplateCall extends Call
    ...
    compileNode: (o) ->
        # Tell `StringWithInterpolations` whether to compile as ES2015 or not; will be removed in Koffee 2.
...
exports.Class = class Class extends Base
    ...
    @: (@variable, @parent, @body = new Block) ->
        @boundFuncs = []
        @body.classBody = yes
...
exports.ModuleSpecifier = class ModuleSpecifier extends Base
    @: (@original, @alias, @moduleDeclarationType) ->
...
exports.Assign = class Assign extends Base
    ...
    @: (@variable, @value, @context, options = {}) ->
    ...
    # operands are only evaluated once, even though we have to reference them more than once.
...
exports.Param = class Param extends Base
    ...
    @: (@name, @value, @splat) ->
        ...
        # the following error doens't throw anymore in koffee (config parameters)
...
exports.Try = class Try extends Base
    ...
    @: (@attempt, @errorVariable, @recovery, @ensure) ->
...
exports.For = class For extends While
    ...
    # Welcome to the hairiest method in all of Koffee. Handles the inner
