...
(function() {
    var BANNER, EventEmitter, FEATURES, Koffee, SWITCHES, baseFileName, bold, compileOptions, compilePath, compileScript, compileStdio, dim, error, exec, findDirectoryIndex, fs, gray, helpers, hidden, isCoffee, logFeatures, makePrelude, merge, mkdirp, nopt, opts, outputPath, pad, parseOptions, path, print, printLine, printTokens, printWarn, ref, ref1, ref2, run, spawn, startRepl, stringify, timeLog, usage, useWinPathSep, version, wait, watchDir, watchFile, watchPath, white, writeJs, yellow;
    ...
    ref2 = require('colorette'), gray = ref2.gray, dim = ref2.dim, bold = ref2.bold, yellow = ref2.yellow, white = ref2.white;
