...
(function() {
    var FILE_EXTENSIONS, Lexer, SourceMap, base64encode, compile, count, formatSourcePosition, fs, getSourceMap, helpers, injectFeature, isCoffee, lexer, log, nameWhitespaceCharacter, parser, path, pkg, sourceMaps, sources, throwSyntaxError, updateSyntaxError, vm, withPrettyErrors,
    ...
    injectFeature = helpers.injectFeature, updateSyntaxError = helpers.updateSyntaxError, nameWhitespaceCharacter = helpers.nameWhitespaceCharacter, throwSyntaxError = helpers.throwSyntaxError, isCoffee = helpers.isCoffee, count = helpers.count;
