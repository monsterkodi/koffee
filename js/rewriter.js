    ...
    Rewriter = (function() {
        ...
        Rewriter.prototype.shortcuts = function() {
            return this.scanTokens(function(token, i, tokens) {
                var close, current, j, open, pushed, ref, ref1, ref2;
                ...
                if (hasFeature(this.opts, 'console_shortcut')) {
                    ...
                    ], i + 1, ['NUMBER', 'IDENTIFIER', 'PROPERTY', 'STRING', 'STRING_START', 'CALL_START', '[', '(', '{', '@'])) {
                        token[0] = 'PROPERTY';
                    ...
                    if (((ref = this.tag(i)) === ']') && tokens[i].spaced && ((ref1 = this.tag(i + 1)) === 'NUMBER' || ref1 === 'STRING' || ref1 === 'STRING_START' || ref1 === 'IDENTIFIER' || ref1 === 'PROPERTY' || ref1 === '{' || ref1 === '(' || ref1 === '[')) {
                        ...
                        while (j--) {
                            ...
                            if (current === close) {
                                ...
                                if (pushed === 0) {
                                    if (j === 0 || ((ref2 = this.tag(j - 1)) !== 'IDENTIFIER' && ref2 !== 'CALL_END')) {
                                        tokens.splice(i + 1, 0, this.generate(',', ','));
                                        break;
                                    }
                                }
                            } else if (current !== 'NUMBER' && current !== 'STRING' && current !== 'PROPERTY' && current !== ':' && current !== ',') {
                                break;
                            }
                        }
                    }
