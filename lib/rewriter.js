...
(function() {
    var BALANCED_PAIRS, CALL_CLOSERS, EXPRESSION_CLOSE, EXPRESSION_END, EXPRESSION_START, IMPLICIT_CALL, IMPLICIT_END, IMPLICIT_FUNC, IMPLICIT_UNSPACED_CALL, INVERSES, LINEBREAKS, Rewriter, SINGLE_CLOSERS, SINGLE_LINERS, k, left, len, ref, rite,
    ...
    Rewriter = (function() {
        ...
        Rewriter.prototype.constructorShortcut = function() {
            return this.scanTokens(function(token, i) {
                var ref;
                if (i > 0 && this.tokens[i - 1][0] === '@' && this.tokens[i][0] === ':' && ((ref = this.tokens[i + 1][0]) === '->' || ref === 'PARAM_START')) {
                    this.tokens[i - 1][0] = 'PROPERTY';
                    this.tokens[i - 1][1] = 'constructor';
                }
                return 1;
            });
        };

        Rewriter.prototype.optionArguments = function() {
            return this.scanTokens(function(token, i) {
                var ref;
                if (i > 0 && this.tokens[i - 1][0] === 'PARAM_START' && this.tokens[i][0] === '{' && ((ref = this.tokens[i + 1][0]) === '@' || ref === 'PROPERTY')) {
                    console.log('before------------------------', this.tokens);
                    this.tokens.splice(i, 0, Rewriter.generate('=', '=', this.tokens[i]));
                    this.tokens.splice(i, 0, Rewriter.generate('IDENTIFIER', 'option_arguments', this.tokens[i + 1]));
