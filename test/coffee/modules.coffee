...
# This is the Koffee import and export syntax, closely modeled after the ES2015 syntax
...
# Koffee also supports:
# export name = …

# Koffee also supports optional commas within `{ … }`.
...
# vague in case the Koffee `class` interpretation changes
test "export class", ->
    input = """
        export class foo
            baz: ->
...
test "export list can contain Koffee keywords", ->
...
test "export list can contain Koffee keywords when aliasing", ->
...
test "Koffee keywords can be used as imported names in import lists", ->
    input = """
